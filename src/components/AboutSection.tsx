    ...
    <section>
      <div className="about-section about-content-card text-light-blue p-5 overflow-auto">
        <div className="text-sm">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.6 }} className="pt-5">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.8 }} className="pt-5">
