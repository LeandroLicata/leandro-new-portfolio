    ...
    <section>
      <div className="about-section about-content-card text-light-blue p-5 h-[75%]">
        <div className="text-xs md:text-sm overflow-auto h-[100%]">
          ...
          <motion.p initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.9 }} className="pt-5">
            Me gradué como{" "}
          ...
          <motion.p initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 1.1 }} className="pt-5">
